...
Food::Food(string _vrsta, string _naziv, double _voda, double _proteini, double _masti, double _ugljikohidrati, string _rok_trajanja, double _dnevna_kol_hrane){
    ...
    protein=_proteini;
    masti=_masti;
    ugljikohidrati=_ugljikohidrati;
    dnevna_kol_hrane=_dnevna_kol_hrane;
    int broj=izvuci()*24+12;
    //cout<<broj<<endl;
    niz = new Pomocna[broj];
    //cout<<"!!!!!"<<endl;
}
